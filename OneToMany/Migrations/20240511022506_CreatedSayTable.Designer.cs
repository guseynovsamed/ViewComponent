...
namespace OneToMany.Migrations
{
    ...
    [Migration("20240511022506_CreatedSayTable")]
    partial class CreatedSayTable
    {
            ...
            modelBuilder.Entity("OneToMany.Models.Blog", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Date = new DateTime(2024, 5, 11, 6, 25, 6, 523, DateTimeKind.Local).AddTicks(7610),
                        ...
                        {
                            Id = 2,
                            Date = new DateTime(2024, 5, 11, 6, 25, 6, 523, DateTimeKind.Local).AddTicks(7640),
